...
$result = dbquery("SELECT template_id, template_key, template_name FROM ".DB_EMAIL_TEMPLATES." ORDER BY template_key");
if (dbrows($result) != 0) {
	$editlist = ""; $sel = "";
	...
	echo "<select name='template_id' class='textbox' size='".dbrows($result)."' onchange='this.form.submit();'>\n".$editlist."</select><br />\n";
